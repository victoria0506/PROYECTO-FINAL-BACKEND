...
const FormAdmin = () => {
  ...
  const Añadir = async () => {
    if (
      !nomResta.trim() || !precioPro.trim() || !capacidad.trim() ||
      !descripcion.trim() || !ubicacion.canton || !ubicacion.distrito ||
      !horarioApertura.trim() || !horarioCierre.trim() ||  isNaN(capacidad)
    ) {
